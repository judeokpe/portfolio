...
export const Howitworks = () => {
  return (
    <div className="flex flex-col md:flex-row md:mb-[100px] bg-gray-100 dark:bg-gray-900 pb-[100px] items-center dark:border-b dark:text-yellow-500 pt-16 justify-between md:my-32 my-16 gap-8 px-4 md:px-12">
